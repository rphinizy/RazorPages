    ...
    public partial class ClientAndAnnotations : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, new DateTime(2022, 11, 7, 10, 22, 48, 38, DateTimeKind.Local).AddTicks(6907), 1 });

            migrationBuilder.InsertData(
                table: "ClientServices",
                columns: new[] { "ID", "ClientID", "Date", "ServicesID" },
                values: new object[] { 3, 1, new DateTime(2022, 11, 7, 10, 22, 48, 41, DateTimeKind.Local).AddTicks(3580), 5 });

            migrationBuilder.InsertData(
                table: "ClientServices",
                columns: new[] { "ID", "ClientID", "Date", "ServicesID" },
                values: new object[] { 2, 2, new DateTime(2022, 11, 7, 10, 22, 48, 41, DateTimeKind.Local).AddTicks(3516), 7 });
