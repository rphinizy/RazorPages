...
namespace RazorPages.Migrations
{
    ...
    [Migration("20221107152248_ClientAndAnnotations")]
            ...
            modelBuilder.Entity("RazorPages.Models.ClientService", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            ClientID = 1,
                            Date = new DateTime(2022, 11, 7, 10, 22, 48, 38, DateTimeKind.Local).AddTicks(6907),
                            ServicesID = 1
                        },
                        new
                        {
                            ID = 2,
                            ClientID = 2,
                            Date = new DateTime(2022, 11, 7, 10, 22, 48, 41, DateTimeKind.Local).AddTicks(3516),
                            ServicesID = 7
                        },
                        new
                        {
                            ID = 3,
                            ClientID = 1,
                            Date = new DateTime(2022, 11, 7, 10, 22, 48, 41, DateTimeKind.Local).AddTicks(3580),
                            ServicesID = 5
                        });
                });
