    ...
    public class SpaContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Services>().HasData(
                ...
                // how are ID 6 and 7 represented as Salon classifications in the database. I cannot figure out where that comes from. 
                //Each attempt at renaming the database and running update-database results in 6 and 7 displaying as Salon.
